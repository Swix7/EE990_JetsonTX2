...
class FPS():
    ...
    def process_fps_counter(self):
        ...
        sleep_interval = 1.0 / 100.0 # Wakeup and time checks N times per sec.
        snapshot_interval = 1.0 / 10.0 # FPS calculate N times per sec. (must snapshot_interval >= sleep_interval)
