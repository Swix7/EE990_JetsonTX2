...
def build_detection_graph(config, checkpoint,
    ...
    if config.model.HasField('ssd'):
        ...
        if input_shape is not None:
            config.model.faster_rcnn.image_resizer.keep_aspect_ratio_resizer.min_dimension = input_shape[0]
            config.model.faster_rcnn.image_resizer.keep_aspect_ratio_resizer.max_dimension = input_shape[1]
